...
import { SAMPLE_BRAND_DECK_FILENAME, SAMPLE_BRAND_DECK_PDF } from "../src/lib/genoma/fixtures/brandkit-paths";
...
async function main() {
  ...
  fs.mkdirSync("docs/genoma-evidence", { recursive: true });
  fs.writeFileSync("docs/genoma-evidence/oaro-ingest-report.json", `${JSON.stringify(report, null, 2)}\n`);
}
