    ...
    <div className="custom-node tool-node project-assets-node foldder-node--frameless node--glass" style={{ minWidth: 200, minHeight: 120 }}>
      ...
      <div className="node-content project-assets-node-content flex min-w-0 flex-col gap-3 px-3 pb-3 pt-2">
        <div className="min-w-0">
          ...
          <div className="project-assets-metrics space-y-2 rounded-none border border-slate-200/60 bg-slate-50/50 p-3 shadow-inner">
        ...
        <button
          ...
          className="project-assets-open-button nodrag flex w-full items-center justify-center gap-2 rounded-none border border-slate-300/80 bg-white/90 px-3 py-2.5 text-center text-[11px] font-bold uppercase tracking-wide text-slate-800 shadow-sm transition hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/50"
        >
