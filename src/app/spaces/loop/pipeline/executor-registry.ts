/**
 * Registro tipo → executor para Loop. Un nodo solo es elegible en la tubería si tiene
...
export class ExecutorRegistry {
  ...
  /** ¿Este tipo de nodo puede entrar en una tubería de Loop? */
...
/** Registro compartido por defecto (poblado por registerDefaultLoopExecutors). */
