/**
 * Loop como orquestador de subgrafo — resolución de inputs por nodo y fila (F2, puro).
 *
 ...
 *
 *   1. Override de columna del Dataset (binding de Loop)  ← máxima prioridad
 ...
 * y este resolutor se testean sin React/Dataset/red. El adaptador de Loop cablea los callbacks.
 */
