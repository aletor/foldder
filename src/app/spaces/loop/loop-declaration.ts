/**
 * Loop — lectura de nodos creativos POR DECLARACIÓN (no hardcode).
 *
 * Este es el punto central de la arquitectura: Loop descubre qué inputs puede
 ...
 * en su registro; Loop no se toca.
 *
...
/** ¿Este tipo de nodo es orquestable por Loop (declarado o derivado)? */
