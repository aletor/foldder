/**
 * Proyección de assets BrandKit → valores operativos para el bloque Marca del Dataset.
 * Incluye colores/imágenes detectados y mosaicos, no solo campos confirmados manualmente.
 */
...
function pickImageUrl(...candidates: Array<string | null | undefined>): string {
...
function collectDiscoveredLogos(assets: ProjectAssetsMetadata): BrainDiscoveredBrandAsset[] {
...
/** Convierte contexto/tono de BrandKit a texto plano (sin markdown ni JSON crudo). */
...
/** Firma estable de proyección visual (colores detectados, slots, galería). */
