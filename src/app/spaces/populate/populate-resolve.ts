/**
 * Populate — resolución de inputs por fila.
 *
...
import { substitutePromptTokens } from "./populate-tokens";
...
export function resolveColumnImageInputsForRow(
  bindings: PopulateBindings | undefined,
  dataset: Dataset,
  rowIndex: number,
...
export function hasColumnBindings(bindings: PopulateBindings | undefined): boolean {
