...
import { finalizePopulateBatchRun } from "./populate-batch-finalize";
...
describe("populate partial run (3 filas, fallo en fila 2)", () => {
  it("conserva 2 resultados y registra el fallo en fila 2", async () => {
    ...
    const afterRow1 = await finalizePopulateBatchRun({
      populateId: "pop_test",
      label: "Populate test",
      projectId: null,
