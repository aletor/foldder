...
describe("Populate dynamic image ref crosses nested space boundary", () => {
  ...
  const populate: Node = { id: "pop", type: "populate", position: { x: 800, y: 0 }, data: {} };
  ...
  it("flattens the portal and re-keys the image binding to the inner generator", () => {
    const expanded = expandSpacePortalTemplateForPipeline([portal, populate], parentEdges);
