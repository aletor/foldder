...
/**
 * Transporte cliente para el executor de Prompt Enhancer dentro de una tubería de Populate.
 * Llama a la MISMA ruta que el nodo Enhancer (`/api/openai/enhance`). Aislado para mockear en tests.
 */

export async function enhancePromptForPopulate(args: { prompt: string }): Promise<string> {
