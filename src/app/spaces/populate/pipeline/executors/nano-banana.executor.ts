...
/**
 * Executor de Image Creation (nanoBanana) para tuberías de Populate.
 * Reusa exactamente el pipeline de generación de Populate/Image Creation (`generatePopulateImage`).
 */

import { estimateGeminiImageGenerationUsd } from "@/lib/pricing-config";
import { generatePopulateImage, type PopulateImageProvider } from "../../populate-generate";
import {
...
function provider(data: Record<string, unknown>): PopulateImageProvider {
