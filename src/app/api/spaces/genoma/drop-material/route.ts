...
import { materialBuffersFromFiles, processMaterialBuffers } from "@/lib/genoma/ingest/material-buffers";
...
} from "@/lib/genoma/logo-intake/ingest-files";
import { saveBatchDocs } from "@/lib/genoma/logo-intake/batch-store";
import { analyzeLogoIntakeFromDocs } from "@/lib/genoma/logo-intake/service";
import {
  applySemanticColorEntryToGenome,
  applySemanticPaletteToGenome,
} from "@/lib/genoma/logo-intake/genome-bridge";
import type { LogoIntakePipelineEvent } from "@/lib/genoma/logo-intake/pipeline";
import type { IntakeDocInput } from "@/lib/genoma/logo-intake/render";

export const runtime = "nodejs";
export const maxDuration = 300;

function mapPipelineEvent(event: LogoIntakePipelineEvent): GenomaIngestStreamEvent | null {
  switch (event.type) {
