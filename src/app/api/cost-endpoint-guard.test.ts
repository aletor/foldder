...
const COST_ENDPOINTS: CostEndpointGuard[] = [
  ...
  { route: "src/app/api/spaces/genoma/crawl/route.ts", services: ['"genoma-llm-synthesis"'] },
  { route: "src/app/api/spaces/genoma/ingest/route.ts", services: ['"genoma-llm-synthesis"'] },
  { route: "src/app/api/spaces/genoma/gallery/generate/route.ts", services: ['"gemini-nano"'] },
...
const WALLET_GATED_SYNC_ENDPOINTS = [
  ...
  "src/app/api/spaces/genoma/crawl/route.ts",
  "src/app/api/spaces/genoma/gallery/generate/route.ts",
