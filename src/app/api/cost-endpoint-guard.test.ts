...
const COST_ENDPOINTS: CostEndpointGuard[] = [
  ...
  { route: "src/app/api/spaces/pdf-scan/ocr/route.ts", services: ['"gemini-vision-analysis"'] },
  ...
  { route: "src/app/api/spaces/nano-banana/export-6k/route.ts", services: ['"replicate-upscale"'] },
...
const WALLET_GATED_SYNC_ENDPOINTS = [
  ...
  "src/app/api/spaces/pdf-scan/ocr/route.ts",
  "src/app/api/spaces/matte/route.ts",
  "src/app/api/spaces/nano-banana/export-6k/route.ts",
