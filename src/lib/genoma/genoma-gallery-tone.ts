import type { GenomaDocument, VisualWorldValue, VoiceValue } from "./genoma-types";
import { slotValue } from "./genoma-gallery-tone-utils";

export function buildGalleryToneExplanation(doc: GenomaDocument, stylePrompt?: string): string {
