import type { Candidate, GalleryValue, GenomaDocument, LogoValue, Provenance, SlotId, SlotState, SourceRef } from "./genoma-types";
import {
...
export function mergeSlotStreamPatch(
  ...
  options?: GenomaStreamMergeOptions,
...
export function countLockedGenomaSlots(slots: GenomaDocument["slots"]): number {
