/**
 * Versionado de Genoma (lección Paso 0 de BrandKit: versionar SIEMPRE que cambie
...
export const GENOMA_SCHEMA_VERSION = "2026-07-05-genoma-core-1";

/** Sube al cambiar CUALQUIER extractor (tipografía, logo, color, imágenes, mensajes). */
export const GENOMA_EXTRACT_VERSION = "2026-07-05-genoma-extract-1";
