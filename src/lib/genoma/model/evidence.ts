/**
 * Genoma — núcleo de evidencia.
 *
 * Principio rector: Genoma NO fusiona. Para cada rasgo hay una lista de
...
/** Extracción nativa (xobject/SVG) diferida tras genoma interactivo. */
