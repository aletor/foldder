 ...
 *
 * Al añadir material a un genoma ya poblado, cada candidato nuevo se compara por
 ...
 *              rasgo). Esto ES la resolución de conflictos de Genoma.
...
/**
 * Clasifica un candidato entrante contra el genoma actual. Puro y determinista:
