import type { Provenance, ProvenanceType, SlotReconciliation } from "./genoma-types";

export type GenomaEvidenceCopy = {
  step: string;
  confidence: string;
  signals: string[];
};
...
const PROVENANCE_LABEL: Record<ProvenanceType, string> = {
  ...
  seed_form: "Indicado al iniciar el genoma",
};
...
export function buildGenomaEvidenceCopy(input: {
