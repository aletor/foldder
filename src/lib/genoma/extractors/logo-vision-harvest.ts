...
import { logLogoBboxRejected, logLogoIsolationPath } from "../ingest/genoma-vision-debug";
import {
...
async function refineLogoCropFromIsolation(
  ...
  hiResCrop: Buffer,
  polarity: GenomaVisionLogoHint["polarity"],
...
): Promise<ScoredGenomaLogoHarvest[] | null> {
