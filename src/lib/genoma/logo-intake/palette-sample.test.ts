...
import { applySemanticPaletteToGenome } from "@/lib/genoma/logo-intake/genome-bridge";
import { emptyGenome, getTrait, crownedCandidates } from "@/lib/genoma/model/trait";
