...
export const USAGE_SERVICES = [
  ...
  { id: "replicate-upscale", label: "Replicate · Upscale export 6K (retirado; ahora local)", category: "ia-image" as const },
  ...
  { id: "layerizer-matting", label: "fal/Replicate · Layerizer matting (BiRefNet)", category: "ia-image" as const },
  ...
  { id: "brand-kit-crawl", label: "BrandKit · Crawl web (estático)", category: "brain" as const },
  { id: "brand-kit-ingest", label: "BrandKit · Ingesta archivos (PDF/imagen)", category: "brain" as const },
  { id: "brand-kit-llm-synthesis", label: "Gemini · BrandKit síntesis (voz/valores/claim)", category: "brain" as const },
...
export function inferServiceIdFromRecord(r: UsageRecordLine): UsageServiceId {
  ...
  if (routePath.includes("/export-6k") || routePath.includes("/nano-banana/export-6k")) return "replicate-upscale";
