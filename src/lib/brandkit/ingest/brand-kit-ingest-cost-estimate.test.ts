...
} from "./brand-kit-ingest-cost-estimate";

describe("estimateBrandKitIngestCost", () => {
  it("suma probe + batch + brand board para moodboard con IA", () => {
    const estimate = estimateBrandKitIngestCost(
      [
        {
  ...
  it("formatea desglose con total", () => {
    ...
    const lines = formatBrandKitIngestCostDetailLines(estimate, "es");
