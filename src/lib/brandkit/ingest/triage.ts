import { triageImageKind } from "../brand-kit-brand-board-image-detect";

export type BrandKitIngestFileKind =
  | "logo_image"
  | "gallery_image"
  | "brand_board_image"
  | "brand_document"
...
export type BrandKitIngestTriageItem = {
  name: string;
  mime: string;
  kind: BrandKitIngestFileKind;
  action: string;
};
...
export function triageBrandKitFilename(name: string, mime: string): BrandKitIngestTriageItem {
