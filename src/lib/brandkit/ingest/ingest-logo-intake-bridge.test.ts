...
vi.mock("@/lib/brandkit/logo-intake/batch-store", () => ({
  saveBatchDocs: vi.fn(),
}));

vi.mock("@/lib/brandkit/logo-intake/crop", () => ({
...
vi.mock("@/lib/brandkit/logo-intake/pipeline", () => ({
