import type { Genome, Trait } from "@/lib/brandkit/model/trait";
import {
  addCandidate,
  createTrait,
  crown,
  ...
  normalizeGenome,
  upsertTrait,
} from "@/lib/brandkit/model/trait";
import { createCandidate, signal } from "@/lib/brandkit/model/evidence";
import type { ColorValue, LogoValue } from "@/lib/brandkit/model/trait-values";
import { colorTraitId, type ColorRole } from "@/lib/brandkit/model/trait-ids";
import { computeCompleteness } from "@/lib/brandkit/projection/completeness";
