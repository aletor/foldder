import type { GalleryValue, BrandKitDocument, SlotState } from "./brand-kit-types";
import type { EssenceValue, VoiceValue, VisualWorldValue } from "./brand-kit-types";
import { finalizeSemanticCandidateSlot } from "./brand-kit-reconcile";
...
export function buildCorpusForQualityCheck(doc: BrandKitDocument, copyUnits?: CopyUnit[]): string {
...
export function validateBrandKitContentQuality(
