/**
 * Rasgo y brandKit: la estructura que SUSTITUYE al merge de Brain.
 *
...
import { BRAND_KIT_SCHEMA_VERSION } from "../brand-kit-version";
...
export interface Genome {
  version: string; // BRAND_KIT_SCHEMA_VERSION
...
export function emptyGenome(): Genome {
  const now = nowIso();
  return {
    version: BRAND_KIT_SCHEMA_VERSION,
    traits: {},
    sources: [],
 ...
 * viejos o corruptos. Nunca lanza; devuelve un brandKit coherente.
 */
