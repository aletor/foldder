import type { BrandKitIngestFileKind } from "./ingest/triage";
...
export function triageImageKind(fileName: string): Extract<BrandKitIngestFileKind, "brand_board_image" | "logo_image" | "gallery_image"> {
