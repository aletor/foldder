...
import { looksLikeFragmentedBelief } from "./brand-kit-evidence";
...
export function hasLegacyBrandKitSlots(raw: unknown): boolean {
  if (!raw || typeof raw !== "object") return false;
  const slots = (raw as BrandKitDocument).slots as LegacySlots | undefined;
...
export function migrateBrandKitDocument(doc: BrandKitDocument, legacy: LegacySlots): BrandKitDocument {
