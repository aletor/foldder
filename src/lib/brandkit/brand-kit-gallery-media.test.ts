...
const SAMPLE_GALLERY: GalleryValue = {
  harvested: [
    ...
    {
      assetId: "/api/spaces/s3-file?key=knowledge-files%2Fu%2FbrandKit%2Fingest%2Fa.png",
      previewUrl: "/api/spaces/s3-file?key=knowledge-files%2Fu%2FbrandKit%2Fingest%2Fa.png",
      included: true,
...
describe("brand-kit-gallery-media", () => {
  ...
  it("applies mirrored preview urls", () => {
    const mirrored = {
      "https://volleyball.it/wp-content/uploads/hero.jpg":
        "/api/spaces/s3-file?key=knowledge-files%2Fu%2FbrandKit%2Fingest%2Fmirrored.jpg",
    };
