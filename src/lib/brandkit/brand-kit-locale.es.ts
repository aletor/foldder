...
export const brandKitLocaleEs = {
  ...
  logo: "Logo",
  gallery: "Galería",
  showcaseRequirementsLead:
    "Completa estos elementos para generar aplicaciones coherentes:",
  showcaseConsistency: (score: number) => `Consistencia de marca ${score}%`,
  showcaseContextLabel: "Contexto",
  showcaseContextLight: "Claro",
  showcaseContextDark: "Oscuro",
  showcaseHeroLabel: "Hero web",
  showcasePostLabel: "Post social 1:1",
  showcaseStoryLabel: "Story 9:16",
  showcaseBannerLabel: "Banner horizontal",
  applicationsTabsLabel: "Secciones de aplicaciones",
  applicationsTabCampaign: "Campaña",
  applicationsTabStationery: "Papelería",
  applicationsTabDigital: "Digital",
  showcaseCampaignConcept: "Concepto",
  showcaseCampaignHeadline: "Headline",
  showcaseCampaignSubheadline: "Subheadline",
  showcaseCampaignCta: "CTA",
  stationeryRequirementsLead: "Confirma logo, paleta y tipografía para generar papelería determinista.",
  stationeryEditContact: "Editar datos de contacto",
  stationeryFieldName: "Nombre",
  stationeryFieldRole: "Cargo",
  stationeryFieldEmail: "Email",
  stationeryFieldPhone: "Teléfono",
  stationeryFieldAddress: "Dirección",
  stationeryFieldWebsite: "Web",
  stationeryFocusPreview: "Vista ampliada de pieza",
  stationeryCloseFocus: "Cerrar vista",
  galleryLibrary: "Biblioteca visual",
  galleryFilterAll: "Todas",
  galleryStats: (approved: number, proposals: number, errors: number) => {
    const parts: string[] = [];
    if (approved > 0) parts.push(`${approved} aprobada${approved === 1 ? "" : "s"}`);
    if (proposals > 0) parts.push(`${proposals} propuesta${proposals === 1 ? "" : "s"}`);
    if (errors > 0) parts.push(`${errors} error${errors === 1 ? "" : "es"}`);
    return parts.length ? parts.join(" · ") : "Sin imágenes";
  },
  galleryCategoryMeta: (total: number, approved: number) =>
    `${total} imagen${total === 1 ? "" : "es"} · ${approved} aprobada${approved === 1 ? "" : "s"}`,
  galleryViewBrief: "Ver brief",
  galleryBriefSheetTitle: (label: string) => `Brief · ${label}`,
  galleryImageView: "Ver",
  galleryImageApprove: "Aprobar",
  galleryImageReplace: "Sustituir",
  galleryImageRegenerate: "Regenerar",
  galleryImageDiscard: "Descartar",
  galleryImageDownload: "Descargar",
  galleryImageSetPrimary: "Imagen principal",
  galleryImageUseCampaign: "Usar en campaña",
  galleryImageStateAuto: "Autoaceptada",
  galleryImageStateApproved: "Aprobada",
  galleryImageStateLocked: "Bloqueada",
  galleryImageStateProposal: "Propuesta",
  galleryImageStateError: "Error",
  galleryImageStateDiscarded: "Descartada",
  gallerySlotErrorNoCharge: "No se realizó un nuevo cargo.",
  gallerySlotRetry: "Reintentar",
  galleryPartialError: (count: number) =>
    `${count} imagen${count === 1 ? "" : "es"} no se generó — revisa el slot y reintenta manualmente.`,
  galleryGenerateCategoryCount: (count: number, label: string) => `Generar ${count}`,
  harvested: "Cosecha",
  ...
  unlock: "Desbloquear",
  proposalAi: "Propuesta IA",
  cellMenuMore: "Más acciones",
  revert: "Revertir",
  restoreConfirmedVersion: "Restaurar versión confirmada",
  locked: "Bloqueado",
  you: "tú",
  live: "Vivo",
  tokens: "Tokens",
  compiled: "Compilado",
  exportStyleGuide: "Exportar BrandKit",
  exportBrandKit: "Exportar BrandKit",
  exportPdf: "Exportar PDF",
  exportTokensJson: "Tokens JSON",
  exportCompiledJson: "Compilado JSON",
  exportReadyLabel: "Listo para exportar",
  exportPendingLabel: "Exportación pendiente",
  exportConfirmedBlocks: "bloques confirmados",
  exportVersionLabel: "Versión",
  exportHeaderMenuLabel: "Exportar",
  exportHeaderDraftHint: "Incluye propuestas y marcas",
  exportHeaderFinalHint: "Solo bloques confirmados",
  saveToMisBrandKits: "Guardar en Mis BrandKits",
  saveToMisBrandKitsBusy: "Guardando…",
  saveToMisBrandKitsDone: "Guardado en Mis BrandKits",
  saveToMisBrandKitsError: "No se pudo guardar en Mis BrandKits",
  saveToMisBrandKitsHint: "Aparecerá en el nodo Inspiration → Mis BrandKits",
  saveToMisBrandKitsEmpty: "Analiza o completa la marca antes de guardarla",
  exportTechnicalLabel: "Exportación técnica",
  exportTechnicalHint: "Tokens y compilado para integraciones",
  downloadStyleGuidePdf: "Exportar PDF",
  ...
  reviewChip: "Borrador",
  sectionStatusReview: "Revisión",
  essenceBrandKicker: "Esencia de marca",
  personality: "Personalidad",
  atelierSynthesisTab: "Síntesis",
  atelierAttributesTab: "Atributos",
  atelierEvidenceTab: "Evidencias",
  atelierHistoryTab: "Historial",
  atelierKeysLabel: "Claves",
  atelierBasedOnEvidence: (count: number) =>
    count === 1 ? "Basado en 1 evidencia" : `Basado en ${count} evidencias`,
  atelierViewSources: "Ver fuentes",
  atelierEvidenceOf: (label: string) => `Evidencia de “${label}”`,
  atelierEvidenceConfidenceHigh: "Confianza: alta",
  atelierEvidenceConfidenceMedium: "Confianza: media",
  atelierEvidenceConfidenceLow: "Confianza: baja",
  atelierEvidenceSourcesAgree: (count: number) =>
    count === 1 ? "1 fuente coincidente" : `${count} fuentes coincidentes`,
  atelierShowFullQuote: "Mostrar fragmento completo",
  atelierHideFullQuote: "Ocultar fragmento",
  atelierContributes: "Aporta",
  atelierSelected: "seleccionada",
  atelierEdit: "Editar",
  atelierReformulate: "Reformular",
  atelierReformulateShorter: "Más breve",
  atelierReformulateDistinct: "Más distintiva",
  atelierReformulateFaithful: "Más fiel a las fuentes",
  atelierViewEvidence: "Ver evidencia",
  atelierExportIncluded: "Incluida en exportación",
  atelierExportPending: "Pendiente de exportación",
  ...
  studioFullStudy: "Editar en estudio",
  exportMenuLabel: "Exportar",
  inspectorEditField: "Editar",
  inspectorSaveField: "Guardar",
  inspectorCancelField: "Cancelar",
  save: "Guardar",
  cancel: "Cancelar",
  ...
  presentationModeHint: "Igual que la versión final del PDF — solo bloques confirmados, sin controles.",
  presentationPendingEyebrow: "Brandbook",
  presentationPendingTitle: (count: number) =>
    `${count} sección${count === 1 ? "" : "es"} pendiente${count === 1 ? "" : "s"} de revisión`,
  presentationPendingHint: "Completa el ADN en modo Edición para incluirlas en el brandbook.",
  presentationPendingCta: "Ir a Edición",
  readerClose: "Cerrar lectura",
  sidebarViewLabel: "Vista",
  sidebarViewEdit: "Edición",
  sidebarViewPresentation: "Presentación",
  sidebarContentLabel: "Contenido",
  sidebarSourcesLabel: "Fuentes",
  confirmedStatus: "Confirmado",
  confirmedStatusFemale: "Confirmada",
  inspectorTabContent: "Síntesis",
  inspectorTabAttributes: "Atributos",
  inspectorTabEvidence: "Evidencias",
  inspectorTabHistory: "Historial",
  inspectorEditText: "Editar texto",
  inspectorEditingTitle: "Editando contenido",
  inspectorProtectedBlock: "Bloque protegido en el PDF de cliente.",
  inspectorPdfReady: "Incluida en exportación",
  inspectorPdfPending: "Pendiente de exportación",
  inspectorHistoryEmpty: "Sin versiones anteriores.",
  inspectorHistoryRestore: "Restaurar esta versión",
  viewDetail: "Ver detalle",
  alternatives: "Alternativas",
  resolveConflict: "Resolver conflicto",
  sourceViewDetail: "Ver detalle",
  sourceReanalyze: "Reanalizar fuente",
  sourceViewContributions: "Ver aportaciones",
  sourceRemove: "Quitar fuente",
  sourceDetailTitle: "Detalle de fuente",
  sourceContributionsHint: "Bloques que usan esta fuente",
  navPreviewLabel: "Vista previa",
  detailEmpty: "Sin contenido de detalle para este bloque.",
  ...
  sidebarDropHero: "Arrastra aquí un documento",
  sidebarOrUrl: "o escribe aquí la web de la marca",
  sidebarUrlPlaceholder: "escribe aquí la web de la marca",
  sidebarAnalysisOptions: "opciones de análisis",
  sidebarIngestTitle: "Analizando material",
  boardEmptyLabel: "libro de marca",
  boardEmptyTitle: "Tu marca, desglosada",
  boardEmptyCopy:
    "Pega una url o suelta material a la izquierda. El ADN aparecerá aquí bloque a bloque — editable y listo para Foldder.",
  boardEmptyCopyOnboarding:
    "Pega una url o suelta material aquí. El ADN aparecerá bloque a bloque — editable y listo para Foldder.",
  boardEmptyStep1: "Analiza la web o sube un manual de marca",
  boardEmptyStep2: "Revisa candidatos y conflictos entre fuentes",
  boardEmptyStep3: "Confirma bloque a bloque lo que representa la marca",
