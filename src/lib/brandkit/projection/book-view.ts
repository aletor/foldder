...
export type BrandKitSourceView = {
  id: string;
  label: string;
  kind: SourceKind;
...
export interface BrandKitBookView {
...
/** Proyecta un brandKit a la vista del libro. Puro. */
export function buildBookView(genome: Genome): BrandKitBookView {
  return {
    logo: {
