import type { Candidate, Provenance, SlotId, VoiceValue, EssenceValue, VisualWorldValue } from "./brand-kit-types";
import { formatReconcileSourceLabel, isSemanticTextSlot } from "./brand-kit-reconcile";
