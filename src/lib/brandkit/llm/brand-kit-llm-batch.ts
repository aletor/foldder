...
const BATCH_SYSTEM_GALLERY_BRIEFS = [
  ...
  "Para places: cada variant debe pedir location-first establishing shot distinto; el lugar es el sujeto. Por defecto vacío o con ocupación ligera; como mucho 1 variante con multitud de fondo si el ADN lo indica. Nunca producto principal, packaging ni retrato protagonista.",
