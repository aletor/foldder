...
export const BrandKitBatchResponseSchema = z.object({
...
export function parseBatchResponse(raw: unknown): z.infer<typeof BrandKitBatchResponseSchema> | null {
  const parsed = BrandKitBatchResponseSchema.safeParse(raw);
