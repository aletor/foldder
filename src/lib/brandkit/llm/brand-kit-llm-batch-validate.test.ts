...
import { buildBatchSlotPatch } from "./brand-kit-batch-slot-patch";
import { validateBatchResponse } from "./brand-kit-llm-batch-validate";
...
describe("brandKit batch validate", () => {
